import { konditerskaya } from './../../JS/data/albums/konditerskaya.js';

let currentTrackItem = null;

function displayTracks(trackList) {
    const tracksContainer = document.querySelector('#konditerskayaTracks');
...
const lyrics = [
    "Порнозвезда, ты сияешь ярче всех (Порнозвезда)",
    "Кекс в моих руках, сладкий, как ты (Кекс)",
    "Золотые рыбки, исполняют желания (Золотые рыбки)",
    "9 жизней, но я трачу их на тебя (9 жизней)",
    "Неон горит, мы в этом свете (Неон)"
];
